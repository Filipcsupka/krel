...
- Status consolidates service/PDB/NetworkPolicy/resource-request/resource-limit/
  ...
  expiry, negative generic conditions/phases, ArgoCD sync/health, HPA metric and
  scaling conditions, and Services whose loaded EndpointSlice/Endpoints objects
  contain no ready backend.
